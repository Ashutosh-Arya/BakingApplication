...
try
{
    ...
    if (choice == 1)
    {
        ...
        {
            Console.WriteLine("passBook for:"+ accountnumber);
    ...
    void CreateAccount()
    {
        ...
        if (bankChoice == 1)
        {
            Console.WriteLine(Commons.Account_number().Length);
            account = new SavingsAccount(accountNo:  Commons.Account_number(), totalBalance: 0.00M, withdrawalLimit: 50000, depositLimit: 200000, customer: customer1, requiredBalance: 2000, bankBranch: sbibank);
            Console.WriteLine(account.ToString());

        }
        else if (bankChoice == 2)
        {
            account = new SavingsAccount(accountNo: Commons.Account_number(), totalBalance: 0.00M, withdrawalLimit: 50000, depositLimit: 200000, customer: customer1, requiredBalance: 2000, bankBranch: icicibank);
            Console.WriteLine(account.ToString());
        }
        else if (bankChoice == 3)
        {
            account = new SavingsAccount(accountNo: Commons.Account_number(), totalBalance: 0.00M, withdrawalLimit: 50000, depositLimit: 200000, customer: customer1, requiredBalance: 2000, bankBranch: centalbank);
            Console.WriteLine(account.ToString());
        }
        else if (bankChoice == 4)
        {
            account = new SavingsAccount(accountNo: Commons.Account_number(), totalBalance: 0.00M, withdrawalLimit: 50000, depositLimit: 200000, customer: customer1, requiredBalance: 2000, bankBranch: hdfcbank);
            Console.WriteLine(account.ToString());
        }
        else
        {
